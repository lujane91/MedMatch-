...
export default function HospitalFellowshipComingSoonPage() {
  return (
    <HospitalShell title="Fellowship">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-mm-text-secondary">
                Fellowship program management is not available in this prototype
