...
export const SEED_TRAINING_OPPORTUNITIES: TrainingOpportunity[] = [
  // Medical Student — Summer Electives
  {
  ...
  },
  {
    ...
    description:
      "Emergency medicine elective with flexible start weeks within August.",
    status: "Open",
  },
  {
    ...
    medjourneyApplicationFeeSar: MEDJOURNEY_APPLICATION_FEE_SAR,
    hospitalFee: { kind: "fee", amountSar: 50 },
    requirements: [
      req("r1", "cv", true, "CV"),
      req("r2", "university-letter", true, "University Letter"),
      req("r3", "academic-transcript", true, "Academic Transcript"),
      req("r4", "vaccination-record", false, "Vaccination Record"),
    ],
    description:
